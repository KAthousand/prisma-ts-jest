...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const users = yield client_1.default.user.findUnique({
            where: {
                id: Number(id)
            },
            select: {
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (user) {
            const updatedUser = yield client_1.default.user.findUnique({
                where: { id: Number(id) },
                select: {
                    username: true,
                    email: true
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const deleted = yield client_1.default.user.delete({
            where: { id: Number(id) }
        });
        if (deleted) {
